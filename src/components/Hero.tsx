        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center flex flex-col-reverse gap-12">
          ...
          >
            <div>
              ...
              <p className="mt-3 text-sm text-slate-500 dark:text-slate-400 leading-relaxed max-w-lg bg-slate-100 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-200 dark:border-slate-700">
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-4 text-sm font-medium text-slate-700 dark:text-slate-300">
              {[
                t('hero.bullet1'),
                t('hero.bullet2'),
                t('hero.bullet3'),
                ...
                <li key={index} className="flex items-start gap-2">
                  <div className="w-5 h-5 rounded-full bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 flex items-center justify-center text-[10px] shrink-0 mt-0.5">
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              <div className="hidden sm:flex items-center gap-2 text-slate-400 dark:text-slate-500">
                <div className="flex -space-x-2">
                  <div className="w-8 h-8 rounded-full bg-slate-300 dark:bg-slate-600 border-2 border-white dark:border-slate-950"></div>
                  <div className="w-8 h-8 rounded-full bg-slate-400 dark:bg-slate-500 border-2 border-white dark:border-slate-950"></div>
                </div>
          ...
          >
            <figure className="relative bg-slate-900/5 dark:bg-slate-800/20 backdrop-blur-xl rounded-2xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.1)] dark:shadow-[0_20px_50px_rgba(8,_112,_184,_0.05)] border border-white/20 overflow-hidden flex flex-col transform-gpu transition-all duration-500 hover:shadow-[0_30px_60px_rgba(16,_185,_129,_0.15)] hover:-translate-y-2">
            ...
            <motion.div 
              ...
              className="absolute -right-6 -bottom-6 bg-white dark:bg-slate-800 p-4 rounded-xl shadow-xl dark:shadow-slate-900/80 border border-slate-100 dark:border-slate-700 flex items-center gap-3 z-20"
            >
              <div className="w-10 h-10 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center text-green-600 dark:text-green-400">
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
              </div>
              <div>
                <div className="text-sm font-bold text-slate-900 dark:text-white">+124%</div>
