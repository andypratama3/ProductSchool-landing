        ...
        >
          ...
          >
            <SpotlightCard spotlightColor="rgba(239, 68, 68, 0.2)"
              className="relative overflow-hidden rounded-3xl bg-slate-900 border border-slate-800 p-8 sm:p-10 group shadow-lg"
            >
          ...
          >
            <SpotlightCard spotlightColor="rgba(14, 165, 233, 0.2)"
              className="relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 sm:p-10 group hover:shadow-2xl hover:shadow-blue-500/10 transition-all"
            >
              <div className="absolute bottom-0 right-0 translate-x-1/4 translate-y-1/4 opacity-10 group-hover:scale-110 group-hover:opacity-20 transition-all duration-700">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4 tracking-tight">WhatsApp / AI Bot 24/7</h3>
          ...
          <motion.div 
            ...
            transition={{ type: "spring", stiffness: 300, damping: 20 }}
          >
            <SpotlightCard spotlightColor="rgba(217, 70, 239, 0.15)"
